...
$total_products = countRows("product");
$query = "select * from product limit $from,5";
...
<body>
    ...
    <div id="container">
        ...
        <div class="main">
                ...
                <tbody>
                    <?php foreach ($products as $product) : ?>
                        <tr data-id="<?php echo $product['productid'] ?>" class="row-align">
                            ...
                            $isInStock = isInStock($sizetype, $product['productid']);
                            ?>
                            <td name='status'><?php echo $isInStock ? "In stock" : "Out stock" ?></td>
                            <td name='comment'><a href="/ASM/admin/comment/commentlist.php?productid=<?= $product['productid'] ?>" class="btn btn-secondary">Comments</a></td>
                            <!------------------------------------------------------------------->
                            <!------------------------------------------------------------------->
                        </tr>
                    <?php endforeach ?>
            ...
            <?php echo pageLinks($total_products, $current_page) ?>
        </div>
    </div>
    <footer>
        <p>
